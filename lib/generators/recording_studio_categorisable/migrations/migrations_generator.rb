...
module RecordingStudioCategorisable
  module Generators
    # Generator to install RecordingStudioCategorisable migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_categorisable:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioCategorisable migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioCategorisable engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_categorisable_pages.rb")
          ...
          timestamp = self.class.next_migration_number(
